...
async def main(args: argparse.Namespace) -> None:
    ...
    try:
        ...
        chains = (
            ...
            if args.chain != "all"
            # Esclusi dal run 'all':
            #  - 'eurospin': nessuna spesa online (fuori scope, solo volantino)
            #  - 'cosicomodo': spider non funzionante (manca mappatura
            #    negozio→baseSiteId, vedi cosicomodo_spider.py)
            else ["esselunga", "conad", "carrefour", "iper", "famila"]
        )
